					...
					<div class="zerogrid">
						<div class="row">
							   <div style="margin: 0px auto; ">
								  ...
								  <label class="col-form-label col-form-label-lg" for="inputLarge">기타장식</label>
								  <input class="form-control " placeholder="기타장식" type="text" id="materialOtherName" required="required">
								</div>
						   </div>
						</div>
						<div class="row">
