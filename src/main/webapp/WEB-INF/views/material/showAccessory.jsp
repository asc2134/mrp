...
$( document ).ready( function() {
	$("#delete").click(function(){
		var data ={};
		data["accessoryNum"] = $("#accessoryNum").val();
		
		if(confirm("삭제하시겠습니까?")){
			 $.ajax({
					type : "POST",
					url : "/deleteAccessory.do",
						...
						<form action="/goUpdate.do" method="post">
							<div class="row">
								   <div style="margin: 0px auto; ">
									  ...
									  <input class="form-control" name="accessoryName" type="text" id="accessoryName" value="${accessory.accessoryname}" readonly="readonly">
									  <input class="form-control" name="accessoryNum" type="hidden" id="accessoryNum" value="${accessory.accessorynum}" >
									  <input class="form-control " type="hidden" id="compNum" name="compNum" value="${accessory.compnum}">
									</div>
							   </div>
							</div>
							<div class="row">
					   		  <div style="margin: 0px auto; ">
								   <div class="form-group">
									  ...
									  <input class="form-control" name="amount" type="number" placeholder="수량" id="amount" readonly="readonly" value="${accessory.amount}">
							...
							<div class="row">
					   		  <div style="margin: 0px auto; ">
								   <div class="form-group">
									  ...
									  <input class="form-control" type="number" name="price" placeholder="가격" id="price" value="${accessory.price}" readonly="readonly">
									</div>
							   </div>
							</div>
							<div class="row">
					   		  <div style="margin: 0px auto; ">
								   <div class="form-group">
									...
									<select id="compName" name="compName" class="form-control" readonly="readonly">
										<option value="${accessory.compname}">${accessory.compname}</option>
									</select>
							   </div>
							</div>
