...
$( document ).ready( function() {
	...
	$("#update").click(function(){
		...
		data["accessoryName"] = $("#accessoryName").val();
						...
						<form action="/goUpdate.do" method="post">
							<div class="row">
								   <div style="margin: 0px auto; ">
									  ...
									  <input class="form-control" name="accessoryName" type="text" id="accessoryName" value="${accessory.accessoryName}">
							...
							<div class="row">
					   		  <div style="margin: 0px auto; ">
								   <div class="form-group">
									  ...
									  <input class="form-control" name="amount" type="number" placeholder="수량" id="amount" value="${accessory.amount}">
							...
							<div class="row">
					   		  <div style="margin: 0px auto; ">
								   <div class="form-group">
									  ...
									  <input class="form-control" type="number" placeholder="가격" id="price" value="${accessory.price}">
									</div>
							   </div>
							</div>
							<div class="row">
